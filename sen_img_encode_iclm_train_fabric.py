...
if __name__ == '__main__':
    ...
    train_dataset = SenImgEncodeCaptionICLMDataset(
        train_data_list, train_coco_dataset, tokenizer, img_processor
    )
    val_dataset = SenImgEncodeCaptionICLMDataset(
        val_data_list, train_coco_dataset, tokenizer, img_processor
    )

    logger = TensorBoardLogger(root_dir=os.path.join(args.result_dir, "logs"), name=args.ex_name)
    fabric = Fabric(
        loggers=logger,
