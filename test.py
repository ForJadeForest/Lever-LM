...
if __name__ == '__main__':
    ...
    with open(
        'result/generated_data/open_flamingo-coco-caption-beam_size:8-few_shot:4-query_top_k:50.json'
    ) as f:
        data = json.load(f)

    rtr_list = []
    for i in range(test_data_num):
        rtr_list.append(data[str(i)]['id_list'][0][:-1])
    ...
    print(get_cider(inferencer, retriever, ice_prompt, 0))
    # zero-shot test
    # if teat_zero_shot:
