...
from src.models import SenImgEncodeCaptionICLMLSTM
...
if __name__ == '__main__':
    ...
    logger = TensorBoardLogger(
        root_dir=os.path.join(args.result_dir, "logs"), name=args.ex_name
    )
    fabric = Fabric(
        loggers=logger,
    ...
    model = SenImgEncodeCaptionICLMLSTM().to(args.device)
